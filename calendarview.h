...
private:
    ...
    QColor m_backgroundCircleColor = QColor(44,167,248,175);

    QColor m_defaultTextColor = QColor(255,255,255,200);
    QColor m_currentDayTextColor = "#2ca7f8";
    QColor m_weekendsTextColor = QColor(255,255,255,200);
    QColor m_selectedTextColor = Qt::white;
    QColor m_festivalTextColor = QColor(255,255,255,200);
    QColor m_notCurrentTextColor = QColor(255,255,255,64);
